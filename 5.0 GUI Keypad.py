...
from PyQt5.QtWidgets import QApplication, QWidget, QTabWidget, QMainWindow, QSpinBox, QMessageBox, QDialog, QListWidget, \
    QLabel, QListWidgetItem, QPushButton, QToolButton, QGridLayout, QVBoxLayout, QHBoxLayout, QLabel, QLineEdit, QLCDNumber, QGraphicsPixmapItem
from PyQt5.QtWidgets import *
import sys
from PyQt5.QtGui import QIcon, QPen, QFont, QPixmap
...
class window_example(QWidget):
    def __init__(self):
        ...
        self.setGeometry(372, 50, 1400, 700)
        ...
        self.header.setStyleSheet('background-color: #ffffff; border: 7px double yellow;-webbkit-border-radius: 22px; border-radius: 22px;')
        ...
        self.btn_new.setStyleSheet('background-color: #0000ff; border: 4px solid brown;-webbkit-border-radius: 22px; border-radius: 22px;')
        self.btn_new.setFont(QFont('Sanserif', 36))
        self.btn_new.setFixedHeight(120)
        self.btn_new.setFixedWidth(407)
        self.btn_new.clicked.connect(self.openTab2)
        self.btn_new.pressed.connect(self.pressed)
        self.btn_new.released.connect(self.released)
        ...
        self.btn_existing.setFixedHeight(120)
        self.btn_existing.setStyleSheet('background-color: #0000ff; border: 4px solid brown;-webkit-border-radius: 22px; border-radius: 22px;')
        self.btn_existing.clicked.connect(self.openTab3)
        self.btn_existing.pressed.connect(self.pressed)
        self.btn_existing.released.connect(self.released)
        ...
        self.username_text.setFixedWidth(290)
        self.username_text.setStyleSheet("background-color: #ffffff; border: 2px solid black;-webbkit-border-radius: 12px; border-radius: 12px;")
        ...
        self.btn1.setStyleSheet("background-color: pink; border: 12px hidden cyan;-webkit-border-radius: 5px; border-radius: 5px;")
        self.btn1.setFont(QFont('Sanserif', 8))
        self.btn1.clicked.connect(self.username_input)
        self.btn1.pressed.connect(self.pressed)
        self.btn1.released.connect(self.released)
        ...
        self.label.setStyleSheet("background-color: #ffffff; border: 2px solid black;-webbkit-border-radius: 12px; border-radius: 12px;")
        ...
        btn1 = QPushButton('1')
        btn1.setStyleSheet("background-color: #0000ff;color: white; border: 4px solid cyan;-webkit-border-radius: 22px; border-radius: 22px;")
        btn1.setGeometry(0, 0, 120, 120)
        btn1.setFont(QFont('Sanserif', 72))
        vbox.addWidget(btn1, 0, 0)
        btn1.clicked.connect(self.value_func41)
        btn1.pressed.connect(self.pressed)
        btn1.released.connect(self.released)

        btn2 = QPushButton("2")
        btn2.setStyleSheet("background-color: #0000ff; color: white; border: 4px solid cyan;-webkit-border-radius: 22px; border-radius: 22px;")
        ...
        btn2.pressed.connect(self.pressed)
        btn2.released.connect(self.released)

        btn3 = QPushButton("3")
        btn3.setStyleSheet("background-color: #0000ff;color: white; border: 4px solid cyan;-webkit-border-radius: 22px; border-radius: 22px;")
        ...
        btn3.pressed.connect(self.pressed)
        btn3.released.connect(self.released)

        btn4 = QPushButton("4")
        btn4.setStyleSheet("background-color: #0000ff;color: white; border: 4px solid cyan;-webkit-border-radius: 22px; border-radius: 22px;")
        ...
        btn4.pressed.connect(self.pressed)
        btn4.released.connect(self.released)

        btn5 = QPushButton("5")
        btn5.setStyleSheet("background-color: #0000ff;color: white; border: 4px solid cyan;-webkit-border-radius: 22px; border-radius: 22px;")
        ...
        btn5.pressed.connect(self.pressed)
        btn5.released.connect(self.released)

        btn6 = QPushButton("6")
        btn6.setStyleSheet("background-color: #0000ff;color: white; border: 4px solid cyan;-webkit-border-radius: 22px; border-radius: 22px;")
        ...
        btn6.pressed.connect(self.pressed)
        btn6.released.connect(self.released)

        btn7 = QPushButton("7")
        btn7.setStyleSheet("background-color: #0000ff;color: white; border: 4px solid cyan;-webkit-border-radius: 22px; border-radius: 22px;")
        ...
        btn7.pressed.connect(self.pressed)
        btn7.released.connect(self.released)

        btn8 = QPushButton("8")
        btn8.setStyleSheet("background-color: #0000ff;color: white; border: 4px solid cyan;-webkit-border-radius: 22px; border-radius: 22px;")
        ...
        btn8.pressed.connect(self.pressed)
        btn8.released.connect(self.released)

        btn9 = QPushButton("9")
        btn9.setStyleSheet("background-color: #0000ff;color: white; border: 4px solid cyan;-webkit-border-radius: 22px; border-radius: 22px;")
        ...
        btn9.pressed.connect(self.pressed)
        btn9.released.connect(self.released)

        btn10 = QPushButton("Del")
        btn10.setStyleSheet("background-color: #0000ff;color: white; border: 4px solid cyan;-webkit-border-radius: 22px; border-radius: 22px;")
        ...
        btn10.pressed.connect(self.pressed)
        btn10.released.connect(self.released)

        btn11 = QPushButton()
        btn11.setText("0")
        btn11.setStyleSheet("background-color: #0000ff;color: white; border: 4px solid cyan;-webkit-border-radius: 22px; border-radius: 22px;")
        ...
        btn11.pressed.connect(self.pressed)
        btn11.released.connect(self.released)

        btn12 = QPushButton("Enter")
        btn12.setStyleSheet("background-color: #0000ff;color: white; border: 4px solid cyan;-webkit-border-radius: 22px; border-radius: 22px;")
        ...
        btn12.pressed.connect(self.pressed)
        btn12.released.connect(self.released)
        ...
        self.username_text2.setFixedWidth(290)
        self.username_text2.setStyleSheet("background-color: #ffffff; border: 2px solid black;-webbkit-border-radius: 12px; border-radius: 12px;")
        ...
        self.btn2.setStyleSheet("background-color: pink; border: 12px hidden cyan;-webkit-border-radius: 5px; border-radius: 5px;")
        self.btn2.setFont(QFont('Sanserif', 8))
        self.btn2.clicked.connect(self.username_input)
        self.btn2.pressed.connect(self.pressed)
        self.btn2.released.connect(self.released)
        ...
        self.label5.setStyleSheet("background-color: #ffffff; border: 2px solid black;-webbkit-border-radius: 12px; border-radius: 12px;")
        ...
        btnx1 = QPushButton("1")
        btnx1.setStyleSheet("background-color: #0000ff; color: white; border: 4px solid cyan;-webkit-border-radius: 22px; border-radius: 22px;")
        ...
        btnx1.pressed.connect(self.pressed)
        btnx1.released.connect(self.released)

        btnx2 = QPushButton("2")
        btnx2.setStyleSheet("background-color: #0000ff; color: white; border: 4px solid cyan;-webkit-border-radius: 22px; border-radius: 22px;")
        ...
        btnx2.pressed.connect(self.pressed)
        btnx2.released.connect(self.released)

        btnx3 = QPushButton("3")
        btnx3.setStyleSheet("background-color: #0000ff;color: white; border: 4px solid cyan;-webkit-border-radius: 22px; border-radius: 22px;")
        ...
        btnx3.pressed.connect(self.pressed)
        btnx3.released.connect(self.released)

        btnx4 = QPushButton("4")
        btnx4.setStyleSheet("background-color: #0000ff;color: white; border: 4px solid cyan;-webkit-border-radius: 22px; border-radius: 22px;")
        ...
        btnx4.pressed.connect(self.pressed)
        btnx4.released.connect(self.released)

        btnx5 = QPushButton("5")
        btnx5.setStyleSheet("background-color: #0000ff;color: white; border: 4px solid cyan;-webkit-border-radius: 22px; border-radius: 22px;")
        ...
        btnx5.pressed.connect(self.pressed)
        btnx5.released.connect(self.released)

        btnx6 = QPushButton("6")
        btnx6.setStyleSheet("background-color: #0000ff;color: white; border: 4px solid cyan;-webkit-border-radius: 22px; border-radius: 22px;")
        ...
        btnx6.pressed.connect(self.pressed)
        btnx6.released.connect(self.released)

        btnx7 = QPushButton("7")
        btnx7.setStyleSheet("background-color: #0000ff;color: white; border: 4px solid cyan;-webkit-border-radius: 22px; border-radius: 22px;")
        ...
        btnx7.pressed.connect(self.pressed)
        btnx7.released.connect(self.released)

        btnx8 = QPushButton("8")
        btnx8.setStyleSheet("background-color: #0000ff;color: white; border: 4px solid cyan;-webkit-border-radius: 22px; border-radius: 22px;")
        ...
        btnx8.pressed.connect(self.pressed)
        btnx8.released.connect(self.released)

        btnx9 = QPushButton("9")
        btnx9.setStyleSheet("background-color: #0000ff;color: white; border: 4px solid cyan;-webkit-border-radius: 22px; border-radius: 22px;")
        ...
        btnx9.pressed.connect(self.pressed)
        btnx9.released.connect(self.released)

        btnx10 = QPushButton("Del")
        btnx10.setStyleSheet("background-color: #0000ff;color: white; border: 4px solid cyan;-webkit-border-radius: 22px; border-radius: 22px;")
        ...
        btnx10.pressed.connect(self.pressed)
        btnx10.released.connect(self.released)

        btnx11 = QPushButton("0")
        btnx11.setStyleSheet("background-color: #0000ff;color: white; border: 4px solid cyan;-webkit-border-radius: 22px; border-radius: 22px;")
        ...
        btnx11.pressed.connect(self.pressed)
        btnx11.released.connect(self.released)

        btnx12 = QPushButton("Enter")
        btnx12.setStyleSheet("background-color: #0000ff;color: white; border: 4px solid cyan;-webkit-border-radius: 22px; border-radius: 22px;")
        ...
        btnx12.pressed.connect(self.pressed)
        btnx12.released.connect(self.released)
        ...
        self.tabs1.addTab(self.tab2, 'Tab 2')
    ...
    def value_func_enter_new(self):
        ...
        if clearance:
            saltPassword = hashlib.pbkdf2_hmac('sha512', text.encode('utf-8'),
                                               self.username.lstrip().rstrip().encode('utf-8'), 1000)
            text = saltPassword.hex()
            # saltPassword = hashlib.sha256(text.encode('utf-8'))
            # text = saltPassword.hexdigest()
    ...
    def value_func_enter_existing(self):
        ...
        for i, line in enumerate(fhandle_read):
            if line.lstrip().rstrip().split()[1] == username:
                saltPassword = hashlib.pbkdf2_hmac('sha512', text.encode('utf-8'), self.username_text2.text().lstrip().rstrip().encode('utf-8'), 1000)
                text = saltPassword.hex()
        ...
        index = 0
        if found:
            check_list_id = [item[0] for item in violators]
            check_list_time = [item[1] for item in violators]
            for k, value in enumerate(check_list_id):
                if value == username:
                    index = k


            if (username not in check_list_id) or (((time.time()) - (check_list_time[index])) > 300):
                if password:
                    settings_dialog = QDialog()
                    settings_dialog.setModal(True)
                    settings_dialog.setStyleSheet("background-color:white")
                    settings_dialog.setWindowTitle("Settings")
                    settings_dialog.setWindowIcon(QIcon("celebration.jpg"))
                    settings_dialog.setGeometry(600, 150, 400, 300)
                    hbox = QHBoxLayout()


                    label22 = QLabel()
                    pixmap = QPixmap('./celebration.jpg')
                    label22.setPixmap(pixmap)
                    settings_dialog.resize(pixmap.width(), pixmap.height())
                    hbox.addWidget(label22)
                    self.playsound()

                    settings_dialog.setLayout(hbox)
                    ...
                    violation += 1
                    if violation > 4:
                        QMessageBox.warning(self, "Warning", "You have entered PIN incorrectly for 5 times\n\nNow you have to wait for 5 Minutes\n\nThen you would be allowed to proceed")
                        new_violator = (username, time.time())
                        violators.append(new_violator)
    ...
    def playsound(self):
        winsound.PlaySound('crowd_clap', winsound.SND_ASYNC)
    def username_input(self):
        settings_dialog = QDialog()
        settings_dialog.setModal(True)
        settings_dialog.setStyleSheet("background-color: #0000ff")
        ...
        self.ledit.setStyleSheet("background-color: #ffffff; border: 4px solid black;-webbkit-border-radius: 12px; border-radius: 12px;")
        ...
        self.proceed_btn.setStyleSheet("background-color: #0000ff; border: 4px solid cyan;-webbkit-border-radius: 22px; border-radius: 22px;")
        self.proceed_btn.clicked.connect(self.close_dialog)
        self.proceed_btn.pressed.connect(self.pressed)
        self.proceed_btn.released.connect(self.released)
    ...
    def playsound_2(self):
        winsound.PlaySound('failure', winsound.SND_ASYNC)
    ...
    def released(self):
        ...
        print("button {} held down for".format(btn_name.text()), p1 - p, "seconds")
