...
class window_example(QWidget):
    ...
    def value_func_enter_new(self):
        ...
        if clearance:
            saltPassword = hashlib.pbkdf2_hmac('sha512', text.encode('utf-8'), self.username.lstrip().rstrip().encode('utf-8'), 1000)
